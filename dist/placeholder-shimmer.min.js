angular.module("ngPlaceholderShimmer",[]).provider("psConfig",function(){this.color="#E2E2E2",this.hgcolor="#F2F2F2",this.timeout=60,this.$get=function(){return this}}).service("psService",["$timeout",function(e){this.process,this.close=function(){this.process&&e.cancel(this.process)}}]).factory("psFactory",["psConfig",function(e){return{createGradient:function(t,r,n){var o=t.createLinearGradient(r,0,2*r,0)
