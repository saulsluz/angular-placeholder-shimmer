angular.module("ngPlaceholderShimmer",[]).provider("psConfig",function(){this.color="#E2E2E2",this.hgcolor="#F2F2F2",this.timeout=60,this.$get=function(){return this}}).service("psService",["$timeout",function(e){this.process,this.close=function(){if(!this.process)throw new Error("none process to close")
